...
forecastRange <- seq(as.Date("2011-01-01"), as.Date("2011-12-31"), by="days")

submission <- data.frame(forecastRange, ARIMA_Four_for$mean)

write.xlsx(submission, file = "submission_schofield_zu.xlsx")
